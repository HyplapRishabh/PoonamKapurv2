                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu {{ Request::is('user*','role*','goal*','rawmaterial*','category*','subcategory*','addon*','mealtype*','product*','package*','pincode*','booking*','blog*','faq*','testimonial*','banner*','coupon*')  ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu ">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item {{ Request::is('banner*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Request::is('buySubscription*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('/buySubscription')}}" id="dashboard" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <span class="menu-text">Buy Subscription</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-section">
                                <h4 class="menu-text">All Orders</h4>
                                <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                            </li>

                            <li class="menu-item {{ Request::is('order/alacart') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('/order/alacart')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                            ...
                            <li class="menu-item {{ Request::is('order/package') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('/order/package')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                            ...
                            <li class="menu-item {{ Request::is('enquiry/bulk') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('enquiry/bulk')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                            ...
                            <li class="menu-item {{ Request::is('order/franchise') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{url('/enquiry/franchise')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
