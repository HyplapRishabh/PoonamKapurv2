        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('/package/packageMenu/importMultiplePackageMenu')}}" enctype="multipart/form-data" method="post">
                        <div class="row">
                            @csrf
                            <div class="col-sm-12 text-left">
                                <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <a href="{{url('storage/ExcelFiles/PackageMenu/MultiPackageMenuExcelFormat.xls')}}" id="download" download class="btn btn-success"><i class="fas fa-cloud-download-alt"></i>or Download format
                                    </a>
                                </div>
                            </div>
                        </div>
