...
<!-- special-pages/order-detail.html   08:53:21 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Poonamkapur.com |Order details</title>
                        ...
                        <table class="table table-borderless product-table rounded">
                            ...
                            <tbody>
                                ...
                                <tr class="cart_item border-bottom">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex ms-4">
                                                <div>
                                                    <h6 class="heading-title text-primary">{{$alacartinfo->productName}}</h6>
                                                    @if(isset($alacartinfo->addonName))
                                                        <p class="mb-0 fw-bolder">{{$alacartinfo->addonName}}</p>
                                                    @else
                                                        <p class="mb-0 fw-bolder">{{$alacartinfo->addonName}}</p>
                                                    @endif
                                    ...
                                    <td class="text-center">
                                        <span class="rowpad">{{$alacartinfo->productPrice + $alacartinfo->addonprice}}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="rowpad">{{($alacartinfo->productPrice + $alacartinfo->addonprice)*$alacartinfo->qty}}</span>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
