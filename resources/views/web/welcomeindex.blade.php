                        ...
                        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item {{$key == 0 ? 'active' : ''}}">
                                    <img src="{{asset($bannerinfo->image)}}"
                                        onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`" alt="Banner"
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                <a href="{{url('/app/alacart')}}" type="button"
                                        ...
                                        <form id="form-wizard1" class="text-center mt-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    pattern="[6789][0-9]{9}" class="form-control"
                                                                    id="qumobile" name="mobile"
                                            ...
                                            <fieldset>
                                                <div class="form-card">
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-12">
                                                            <p class=" text-center">Your BMI is <span
                                                                    id="BMIShow"></span> & Your BMR is <span
                                                                    id="BMRShow"></span> </p>
                                                            <h4 id='less19' class="purple-text text-center">We recommend
                                                                you
                                                                <a name="dsfg" class=""
                                                                    href="/app/goal/indian-balanced-meal?goal=3&pkgId=13&meal=Veg">Balanced
                                                                    meal </a>package
                                                            </h4>
                                                            <h4 id='more25' class="purple-text text-center">We recommend
                                                                you
                                                                <a name="dsfg" class=""
                                                                    href="/app/goal/weight-loss?goal=1&pkgId=1&meal=Veg">Weight
                                                                    loss </a>package
                                                            </h4>
                                                        </div>
                                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <img src="{{asset($testimonialInfo->media)}}"
                                                    onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`"
                                                    alt="{{$testimonialInfo->name}}"
                                                    class="img-fluid rounded-circle avatar-100 mb-2"><br>
