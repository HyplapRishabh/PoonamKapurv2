                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card " data-iq-gsap="onStart" data-iq-opacity="0" data-iq-position-y="-40"
                        ...
                        <div class="hero-image p-3"
                            style="background: url('webassets/images/layouts/01.png') no-repeat center right;background-size: cover;background-position: center;">
                                ...
                                <div class="row banner-container">
                                    <div class="col-lg-12 banner-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--    <a href="{{url('/app/allcategory')}}" type="button"-->
                                            <!--        class="btn  btn-primary rounded-pill"-->
                                            <!--        style="margin: 5%;padding:5%;width:100%;">Let's Get Started</a>-->
                                            <!--</div>-->
                                            <div class="col-lg-3 col-md-3 col-sm-12">
