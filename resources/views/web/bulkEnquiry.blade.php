                        ...
                        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a>
                                        <img src="{{url('webassets/images/bulkenquiry.png')}}" onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`" alt="Banner" class="d-block w-100" alt="#">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12  ">
                    <div class="dish-card-vertical1">
                        <div class="card dish-card3">
                            <div class="card-body">
                                <form method="post" id="bulkForm" action="{{url('/app/submitBulkEnquiry')}}" class="text-center mt-3">
                                    @csrf
