...
<head>
    ...
    <title>{{$categorydtl->title}}</title>

    <meta name="description" content="{{$categorydtl->metaDescription}}">

    <meta name="keywords" content="{{$categorydtl->metaKeywords}}">
    ...
    <main class="main-content">
        ...
        <div class="content-inner mt-5 py-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card" data-iq-gsap="onStart" data-iq-opacity="0" data-iq-position-y="-40" data-iq-duration=".6" data-iq-delay=".7" data-iq-trigger="scroll" data-iq-ease="none">
                        ...
                        <div class="card-body py-0" id='catdiv'>
                            <ul class="list-inline list-main iq-special-product">
                                ...
                                <li onclick="changemealtype('{{$mealinfo->webmealtype->name}}')" class="py-3 d-flex align-items-center btn {{ $input['mealtype']==$mealinfo->webmealtype->name ? 'btnheighlight' : '' }}">
