                  ...
                  <div class="col-md-10">
                     <div class="d-flex justify-content-center mb-0">
                        <div class="card-body text-center">
                           ...
                           <form action="{{url('/resetpasscheckemail')}}" method="post" onsubmit="checkresetpass(event)" id="myresetform">
                           <div class="row text-start">
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                 <label for="email" class="form-label">Email Id</label>
                                       <input type="email" class="form-control form-control-sm" name='useremail' id="uemail" aria-describedby="email" placeholder=" ">
