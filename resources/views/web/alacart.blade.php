                                        ...
                                        <div class="card-body">
                                            <a href="{{url('/app/category/')}}/{{Str::slug($catinfo->name)}}?category={{Str::slug($catinfo->name)}}">
                                                <div class="text-center iq-menu-category">
                                                    <img src="{{asset($catinfo->image)}}" onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`" alt="{{$catinfo->name}}" class="img-fluid rounded-pill avatar-100 mb-3">
                                        ...
                                        <div class="card card-white dish-card profile-img mb-0">
                                            <div class="profile-img21">
                                                <a style="all:unset" href="{{url('/app/dish/')}}/{{$productinfo->slug}}">
                                                    <img src="{{asset($productinfo->image)}}" onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`" alt="{{$productinfo->name}}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom" alt="profile-image">
                                                    <img src="{{asset($productinfo->image)}}" onerror="src=`{{ asset('webassets/images/greyimage.jpg')}}`" alt="{{$productinfo->name}}" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image" data-iq-gsap="onStart" data-iq-opacity="0" data-iq-scale=".6" data-iq-rotate="180" data-iq-duration="1" data-iq-delay=".6" data-iq-trigger="scroll" data-iq-ease="none">
                                                </a>
                                            </div>
                                            <div class="card-body menu-image">
                                                ...
                                                <div class="d-flex justify-content-between mt-3">
                                                    ...
                                                    <a onclick="displayaddon('0','{{$productinfo->id}}','{{$productinfo->mealTypeId}}')" class="btn btn-outline-primary rounded-pill">Add</a>
