<button type="button" style="display:none" id="addonmodalbtn" data-bs-toggle="modal"
            data-bs-target="#addonmodal"></button>
        <div class="modal fade" id="addonmodal" tabindex="-1" role="dialog" aria-labelledby="addonmodal"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: 60vh; overflow-y: auto;">
                        <input type="hidden" value="" id="addonhiddenpid" name="addonhiddenpid">
                        <table class="table table-sm table-borderless">
                            ...
                            <tbody class="p-0" id="addondisplay">
                            </tbody>
                        </table>
                    </div>
        ...
        <footer class="footer">
            <div class="footer-body">
                ...
                <div class="right-panel" style="text-align:center">
                    ©
                    <script>document.write(new Date().getFullYear())</script> www.poonamkapur.com <br>Made with
                    ...
                    </span> by <a href="https://www.hyplap.com">HYPLAP</a>.
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->